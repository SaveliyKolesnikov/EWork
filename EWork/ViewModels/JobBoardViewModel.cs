...
namespace EWork.ViewModels
{
    ...
    {
        public JobBoardViewModel(Job[] jobs, JobController.FilterModel filterModel, string searchUrl, string getJobsAjaxMethodUrl, int takeAmount, User currentUser = null)
